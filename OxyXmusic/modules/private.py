            ...
            [
                [
                    InlineKeyboardButton(
                        "➕ α∂∂ мε тσ үσυя gяσυρ 🙋‍♀️",
                        url=f"https://t.me/{BOT_USERNAME}?startgroup=true",
                    )
                ],
                [
                    InlineKeyboardButton(
                        "❤️ αвσυт σxү ❤️", url=f"https://t.me/{UPDATES_CHANNEL}"
                    ),
                    InlineKeyboardButton(
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "💬 sυρρσят cнαт", url=f"https://t.me/{SUPPORT_GROUP}"
                    )
                ]
            ]
        ),
...
def map(pos):
    if pos == 1:
        ...
        button = [
            ...
            [
                InlineKeyboardButton(
                    text="❤️ αвσυт σxү ❤️", url=f"https://t.me/{UPDATES_CHANNEL}"
                ),
                InlineKeyboardButton(
                    text="💬 sυρρσят", url=f"https://t.me/{SUPPORT_GROUP}"
                ),
            ],
            [
                InlineKeyboardButton(
                    text="🔥 мү σωηεя 🔥", url=f"https://t.me/FallenAngel_xD"
                )
            ],
